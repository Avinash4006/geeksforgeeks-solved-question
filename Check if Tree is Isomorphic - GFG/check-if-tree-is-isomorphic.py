...
class Solution:
    ...
    def isIsomorphic(self, root1, root2):
        ...
        # Check if the root nodes have the same data.
        if root1.data != root2.data:
            return False

        # Check if swapping left and right subtrees at the current node makes the trees isomorphic.
        # Either both subtrees are swapped or neither is swapped.
        return ((self.isIsomorphic(root1.left, root2.left) and self.isIsomorphic(root1.right, root2.right)) or
